...
def tanul():
    tudasPlusz(30)
    print('Megtanultam a mai anyag egy részét, holnap jobban fognak menni a dolgozatok.')
    etel(20)
    idoMeres(1, 0)
    ...
    while m != '6' :
        ...
        match m:
            ...
            case '2':
                ...
                idoMeres(0, 45)     
                statPrint()
                print("\nElfeküdtél és jól körbenéztél a közösségi oldalokon")
                input("Enter") 
                voltSzoba = True      
            case '3':   
                os.system("cls")
